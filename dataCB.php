        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Data Absensi Caberawit</h1>
                    <hr />
...
<script>
    ...
    $("#example").on("click", ".edit-btn", function () {
        ...
        window.location.href = "editDataCB.php?id=" + id;
    });
});
