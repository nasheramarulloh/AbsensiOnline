...
<body class="sb-nav-fixed">
    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <a class="navbar-brand ps-3" href="#">HALAMAN PD</a>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Absensi Paud</h1>
                    <hr />
                    <div class="card mb-3">
                        <div class="card-header">
                            <i class="fas fa-table me-1"></i>
                            Table Kehadiran Paud
                        </div>
                        <div class="card-body">
                            ...
                            <div class="table-responsive " style="max-height: 400px; overflow-y: auto;">
                                ...
                                <thead class="table-dark">
                                    ...
                                    <?php
                                        ...
                                        $query = "SELECT id, nama_lengkap, jenis_kelamin, usia, status, acara, keterangan, alasan, tanggal, jam FROM paud ORDER BY tanggal DESC";
...
<script>
    ...
    $("#example").on("click", ".edit-btn", function () {
        ...
        window.location.href = "editPaud.php?id=" + id;
    });
});
