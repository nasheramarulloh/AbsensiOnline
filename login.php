...
<body>
    <div class="login-container text-center">
        ...
        <form action="login.php" method="post">
            ...
            <a href="lupaPassword.php" class="btn btn-outline-primary w-100 mt-2">Lupa Password</a>
            <a href="register.php" class="btn btn-outline-primary w-100 mt-2">Belum Punya akun? Daftar</a>
            <hr>
            <a href="LoginAdmin.php">Masuk Jadi Admin</a>
        </form>
    </div>
</body>
</html>