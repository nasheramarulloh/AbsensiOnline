        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Data Absensi Pengurus</h1>
                    <hr />
                                ...
                                <thead class="table-dark">
                                    ...
                                    <?php
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo "<td>
                                                    <button class='btn btn-primary btn-sm edit-btn mb-1 w-100' data-id='" . $row['id'] . "'>
...
<script>
    ...
    $("#example").on("click", ".edit-btn", function () {
        ...
        window.location.href = "editDataPengurus.php?id=" + id;
    });
});
